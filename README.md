...
```javascript
exp2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-exp2@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-exp2/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-exp2/actions/workflows/test.yml?query=branch:v0.3.1
